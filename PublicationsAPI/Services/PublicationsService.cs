...
namespace PublicationsAPI.Services {
    public class PublicationsService : IPublicationsService
    {
        ...
        {
            return _publicationsRepository.DeletePublicationAsync(publicationUuid);
        }
        ...
        {
            return ((await _usersServices.GetPublicationsByUserUuidAsync(publisherUuid)).Select(p => p.PublicationsToPublicationResponseDTO())).ToList();
        }
        ...
        public async Task<PublicationResponseDTO> UpdatePublicationAsync(string publicationUuid, PublicationDTO publicationDto)
        {
            ...
            return (await _publicationsRepository.UpdatePublicationAsync(publicationToUpdate)).PublicationsToPublicationResponseDTO();
        }
    }
}